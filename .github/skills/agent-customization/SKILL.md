...
| Type | File | Location |
|------|------|----------|
| Workspace Instructions | `copilot-instructions.md`, `AGENTS.md` | `.github/` or root |
...
- Add the body content following the templates below
- Verify `name` in frontmatter matches the folder name exactly
